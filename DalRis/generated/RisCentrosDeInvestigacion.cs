...
namespace DalRis
{
	...
	public partial class RisCentrosDeInvestigacion : ActiveRecord<RisCentrosDeInvestigacion>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("RIS_CentrosDeInvestigacion", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("RIS_CentrosDeInvestigacion",schema);
			}
		}
		#endregion
